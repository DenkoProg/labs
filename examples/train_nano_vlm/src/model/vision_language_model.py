...
from src.model.modality_projector import ModalityProjector
from src.model.utils import top_k_top_p_filtering
from src.model.vision_transformer import ViT
    ...
    def forward(self, input_ids, image, attention_mask=None, targets=None):
        ...
        if attention_mask is not None:
            ...
            image_attention_mask = torch.ones(
                (batch_size, img_seq_len), device=attention_mask.device, dtype=attention_mask.dtype
            )
